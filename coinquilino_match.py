...
# Profili
preferenze_francesca = Preferenze({     #istanza preferenze
    criteri["ORDINE"]: "F",
    criteri["RUMORE"]: "S",
    criteri["ANIMALI"]: "F",
    criteri["FESTE"]: "I",
...
preferenze_sibilla = Preferenze({     #istanza preferenze
    criteri["ORDINE"]: "F",
    criteri["RUMORE"]: "I",
    criteri["ANIMALI"]: "I",
    criteri["FESTE"]: "S",
...
preferenze_lorenzo = Preferenze({     #istanza preferenze
    criteri["ORDINE"]: "F",
    criteri["RUMORE"]: "S",
    criteri["ANIMALI"]: "I",
    criteri["FESTE"]: "I",
...
preferenze_luca = Preferenze({     #istanza preferenze
    criteri["ORDINE"]: "F",
    criteri["RUMORE"]: "I",
    criteri["ANIMALI"]: "I",
    criteri["FESTE"]: "I",
...
preferenze_giovanna = Preferenze({     #istanza preferenze
    criteri["ORDINE"]: "F",
    criteri["RUMORE"]: "S",
    criteri["ANIMALI"]: "S",
    criteri["FESTE"]: "F",
...
preferenze_loris = Preferenze({     #istanza preferenze
    criteri["ORDINE"]: "F",
    criteri["RUMORE"]: "S",
    criteri["ANIMALI"]: "I",
    criteri["FESTE"]: "I",
...
def mostra_classifica_match(utente_target: Persona, lista_candidati: list[Persona]):
    ...
    for risultato in risultati:
        print(f"\nCoinquilino: {risultato.persona2.nome}")
